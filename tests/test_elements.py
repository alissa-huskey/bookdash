...
from . import DATADIR, filecontents
from bookdash import log
from bookdash.elements import Element, BookElement


@pytest.mark.parametrize("filecontents", [{'filename': "dice.html"}], indirect=True)
